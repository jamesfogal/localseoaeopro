...
export default function BlogCalendarGenerator({ industry, city, businessName, mode, plan = "free" }) {
  return <ContentModule
    tag="BCG" label="Blog Calendar Generator" color="#FBBF24" outputLabel="12-Month Calendar" plan={plan}
