/**
 * LocalRank Pro — GBP Post Scheduler
...
- Posts expire after 7 days — must post consistently
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: "user",
            content: `Generate 90-day GBP post calendar:
Business: ${businessName || "Local Business"}
Industry: ${industry || "Local Services"}
City: ${city || "their city"}
Plan: ${plan}

Generate 26 posts (2 per week × 13 weeks).
...
Write each post as if the business owner wrote it personally.`
      ...
      setResult({
        calendarTitle: `${businessName || "Citywide Alarms"} — 90-Day GBP Content Calendar`,
        totalPosts: 26,
        postsPerWeek: 2,
        ...
        posts: [
          { postNumber: 1, scheduledDate: "Week 1 — Monday", type: "service-spotlight", headline: `Is your home truly protected? ${city || "St. Charles"} residents may be surprised.`, body: `A lot of homeowners in ${city || "St. Charles"} think their basic home alarm is enough — until we show them what they're missing. At ${businessName || "Citywide Alarms"}, we do a 15-point security review for every new client, and what we find surprises most people.\n\nDo your sensors cover every entry point? Are your windows protected, not just your doors? Is your monitoring 24/7 — or does it drop during power outages?\n\nThese aren't scare tactics. They're real questions that determine whether your alarm actually stops a break-in or just makes noise after the fact.\n\nThis month we're offering free security reviews for ${city || "St. Charles"} residents. No pressure, no sales pitch — just a professional walkthrough of what you have and what you might want to consider.\n\nCall us or book online to schedule yours.`, callToAction: "Book Online", photoDescription: "Technician doing professional walkthrough of a home exterior with clipboard, sunny day, suburban home", keywords: [`alarm company ${city || "St. Charles"}`, "home security review"], localSignal: `City name appears twice, mentions local scheduling and local homeowners — strong geographic relevance signal` },
          { postNumber: 2, scheduledDate: "Week 1 — Thursday", type: "educational", headline: "The one place most home alarms can't protect — do you have it covered?", body: `Here's something most alarm companies don't tell you: the majority of break-ins don't happen through the front door.\n\nAccording to security data, garage doors, basement windows, and sliding glass doors are the most common entry points — and they're also the most commonly unprotected by basic alarm systems.\n\nAt ${businessName || "Citywide Alarms"}, every system we install in ${city || "St. Charles"} and surrounding areas includes a full vulnerability assessment before we recommend a single sensor. We look at your home the same way a burglar would.\n\nHere's what to check tonight: go to your garage door — can it be opened from outside with a coat hanger through the top panel? If so, you need a garage door monitor sensor. They cost $40. They prevent thousands in losses.\n\nProtection starts with awareness. Questions? Message us anytime.`, callToAction: "Learn More", photoDescription: "Close-up of garage door sensor being installed, hands of technician, clean professional look", keywords: ["home security tips", `alarm sensors ${city || "St. Charles"}`], localSignal: "Local city name + educational authority positioning" },
          { postNumber: 3, scheduledDate: "Week 2 — Monday", type: "completed-project", headline: `Another commercial fire alarm system installed right here in ${city || "St. Charles"}`, body: `Last week our crew wrapped up a full commercial fire alarm upgrade for a local restaurant in ${city || "St. Charles"}. The old system was 15 years old — code compliant when installed, but well past the inspection threshold.\n\nHere's what we upgraded:\n• Heat detectors in the kitchen replaced with new dual-sensor units\n• Smoke detectors in the dining area upgraded to photoelectric models\n• Strobe lights added for hearing-impaired compliance\n• Central monitoring tied to the fire department with a 30-second response protocol\n\nThe whole job took one day, the restaurant stayed open during the install, and the owner now has a system that will pass any inspection for the next 15+ years.\n\nIf your commercial space hasn't had a fire alarm inspection in the last 3 years, call us. We'll tell you honestly where you stand.`, callToAction: "Get Quote", photoDescription: "Professional photo of commercial fire alarm panel mounted on wall, clean and modern installation", keywords: [`commercial fire alarm ${city || "St. Charles"}`, "fire alarm installation"], localSignal: "City name, local business reference, specific job details establish local authority" },
          { postNumber: 4, scheduledDate: "Week 2 — Thursday", type: "seasonal-offer", headline: `Spring Home Security Special — ${city || "St. Charles"} residents save $100 this month`, body: `Spring is when most burglaries in our area happen — families are traveling, windows are open, and people are distracted. It's also the best time to make sure your home is protected before summer travel season.\n\nThis month only, ${businessName || "Citywide Alarms"} is offering $100 off new home security system installations in ${city || "St. Charles"} and surrounding areas.\n\nWhat's included:\n• Professional security assessment\n• Equipment installation (sensors, panel, keypad)\n• 30 days of free monitoring to test everything\n• Direct line to your technician for 90 days\n\nOffer ends April 30th. Appointments are booking 2 weeks out so don't wait.\n\nCall today or book online — we'd love to protect another ${city || "St. Charles"} family.`, callToAction: "Call Now", photoDescription: "Spring front porch of suburban home, bright day, welcoming aesthetic with security camera visible", keywords: [`home security special ${city || "St. Charles"}`, "spring security deal"], localSignal: "City mentioned 3 times, seasonal relevance, urgency with deadline" },
          { postNumber: 5, scheduledDate: "Week 3 — Monday", type: "faq", headline: `"How much does a home alarm system cost in ${city || "St. Charles"}?" — we'll tell you straight`, body: `We get this question every day, and we'll give you an honest answer instead of the usual "it depends."\n\nFor a standard ${city || "St. Charles"} home (3-4 bedrooms, 2 entry points, basement):\n\n Equipment installation: $299–$699 depending on sensor count and camera addition\n Monthly monitoring: $28–$55 depending on response level\n Contract: Month-to-month (we don't lock you in)\n\nFor a senior living alone or monitoring situation: $35–$55/month total including a medical alert button and direct dispatch capability.\n\nFor commercial: Pricing varies significantly by square footage and fire code requirements — we'll give you a written quote within 24 hours of an assessment.\n\nNo hidden fees. No activation charges. The price we quote is the price you pay. That's been our policy since day one in ${city || "St. Charles"}.\n\nAny other questions? Just message us.`, callToAction: "Get Quote", photoDescription: "Simple, professional photo of a home alarm keypad with green status light, clean wall mount", keywords: [`alarm system cost ${city || "St. Charles"}`, "home security pricing"], localSignal: "City name 3x, direct pricing builds trust + AI citation signal for price queries" },
        ]
      });
    }
    setRunning(false);
    ...
    <div style={{ maxWidth: 620, fontFamily: "var(--font-sans)" }}>
      ...
      <div style={{ background: "var(--color-background-secondary)", border: "0.5px solid var(--color-border-tertiary)", borderRadius: 10, padding: "14px 16px", marginBottom: 12, display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: 11, color: "var(--color-text-secondary)", margin: 0, lineHeight: 1.5 }}>
            Claude generates a 90-day GBP content calendar — 26 posts across 7 types — specific to your industry, city, and season. Paid plan auto-publishes to your GBP on schedule. No human writing ever required.
          </p>
        </div>
        <button onClick={generate} disabled={running} style={{ padding: "8px 14px", background: running ? "transparent" : MODULE_COLOR, border: `0.5px solid ${MODULE_COLOR}`, borderRadius: 6, color: running ? MODULE_COLOR : "#0B0E16", fontSize: 12, fontWeight: 500, cursor: running ? "not-allowed" : "pointer", whiteSpace: "nowrap", flexShrink: 0 }}>
          {running ? "Generating..." : result ? "Regenerate →" : "Generate Calendar →"}
        </button>
      </div>
                ...
                <div key={post.postNumber} style={{ borderBottom: i < displayPosts.length - 1 ? "0.5px solid var(--color-border-tertiary)" : "none" }}>
                  <div onClick={() => setExpanded(isExp ? null : i)} style={{ display: "flex", gap: 10, alignItems: "flex-start", padding: "10px 12px", cursor: "pointer", background: isPub ? "#34D39906" : isExp ? "var(--color-background-secondary)" : "transparent" }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: 10, color: "var(--color-text-secondary)" }}>{post.scheduledDate} · CTA: {post.callToAction}</div>
                    </div>
                    <div style={{ display: "flex", gap: 5, alignItems: "center", flexShrink: 0 }}>
                      {isPub && <span style={{ fontSize: 9, color: "#34D399" }}>✓ Published</span>}
      ...
      {!result && !running && (
        <div style={{ textAlign: "center", padding: "36px 20px", background: "var(--color-background-secondary)", border: "0.5px solid var(--color-border-tertiary)", borderRadius: 10, color: "var(--color-text-secondary)", fontSize: 12 }}>
          Generates a 90-day GBP content calendar. No writing required — Claude does it all.
        </div>
      )}
    </div>
  );
