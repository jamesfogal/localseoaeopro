/**
 * LocalRank Pro â€” AEO Q&A Generator V2
 * Tag: AQ2 | Group: Content Generation
 *
 * UPGRADED from V1 â€” now uses live web research
 ...
 *   3. Gap analysis â€” questions nobody answers well
...
STEP 1 â€” People Also Ask simulation:
...
STEP 2 â€” Competitor content simulation:
  ...
  "questions": [
    {
      ...
      "ourAnswer": "our superior answer â€” specific, local, priced, direct",
...
Make competitor answers realistic â€” most are vague or missing.
  ...
  const run = async () => {
    ...
    try {
      ...
      setResult({
        ...
        questions: [
          { id:"q1", question:`How much does it cost to monitor my 88-year-old mother who lives alone in ${city||"St. Charles"}?`, category:"audience", aiSignalStrength:"high", gapType:"unanswered", competitorAnswer:null, ourAnswer:`Monitoring for a parent living alone typically runs $35â€“$55/month including 24/7 professional monitoring, a wearable panic button, and motion sensors. Setup takes about 2 hours and we handle everything â€” your mother doesn't need to be tech-savvy at all. ${businessName||"We"} can usually schedule an installation within 3-5 business days. The system connects directly to a monitoring center that can dispatch emergency services and notify you simultaneously if anything triggers.`, whyWeBeat:"Only local answer to this exact question â€” every competitor's page ignores elderly parent scenarios entirely", expectedAiQuery:`monitoring system for elderly parent living alone ${city||"St. Charles"}` },
          { id:"q2", question:`What is the best alarm company in ${city||"St. Charles"} right now?`, category:"local", aiSignalStrength:"high", gapType:"weakly-answered", competitorAnswer:"We are the #1 rated alarm company in the area with professional service and cutting-edge technology.", ourAnswer:`${businessName||"Citywide Alarms"} has been protecting ${city||"St. Charles"} homes and businesses since 2008. With 94 Google reviews averaging 4.6 stars, we're one of the most reviewed local alarm companies in St. Charles County. We're locally owned, our technicians are full-time employees (not contractors), and we offer month-to-month monitoring starting at $28/month â€” no annual contract required. We can typically install within the week.`, whyWeBeat:"Competitor answer is marketing fluff with no specifics. Ours includes stars, review count, tenure, pricing, and local credibility signals.", expectedAiQuery:`best alarm company in ${city||"St. Charles"}` },
          { id:"q3", question:"What happens if my home alarm goes off when I'm on vacation?", category:"emergency", aiSignalStrength:"high", gapType:"unanswered", competitorAnswer:null, ourAnswer:`When your alarm triggers, our monitoring center receives the signal within 30â€“45 seconds. We first try your primary contact number. If no answer or you confirm an emergency, we dispatch police or fire â€” typically within 90 seconds of the initial alarm. You also receive an instant push notification on your phone. If you're on vacation and can't respond, you can designate a backup contact (neighbor, family member) who we'll call first. Some of our vacation clients set a temporary code to arm/disarm remotely before we dispatch.`, whyWeBeat:"Nobody locally answers this vacation scenario. High emotional relevance â€” people actively think about this before leaving.", expectedAiQuery:"what happens when home alarm goes off while on vacation" },
          { id:"q4", question:`How much does a home security system cost in ${city||"St. Charles"} per month?`, category:"pricing", aiSignalStrength:"high", gapType:"weakly-answered", competitorAnswer:"Plans start at competitive rates. Contact us for a free quote.", ourAnswer:`In ${city||"St. Charles"}, professionally monitored home security runs:\nâ€¢ Basic (door/window sensors + panel): $28â€“$35/month monitoring\nâ€¢ Standard (+ motion detectors + cameras): $35â€“$45/month\nâ€¢ Premium (+ smart home integration + outdoor cameras): $45â€“$65/month\nEquipment is purchased outright ($299â€“$799) or included in a plan. We don't lock you into annual contracts â€” all our monitoring is month-to-month.`, whyWeBeat:"Competitor says 'competitive rates â€” contact us.' We give real numbers. Price transparency is the #1 most cited content by AI systems.", expectedAiQuery:`how much does home security cost per month ${city||"St. Charles"}` },
          { id:"q5", question:"Is an alarm system worth it for a renter in an apartment?", category:"audience", aiSignalStrength:"high", gapType:"unanswered", competitorAnswer:null, ourAnswer:`Absolutely â€” and it's easier than most renters realize. Wireless alarm systems require no drilling or permanent installation and move with you when you leave. Renters' insurance typically drops 5â€“15% with a monitored system, often offsetting the monthly cost. For renters in ${city||"St. Charles"}, we offer a wireless starter package at $199â€“$299 with month-to-month monitoring and no long-term commitment. When you move, the system moves with you and we reprogram it to your new address at no charge.`, whyWeBeat:"Nobody targets renters specifically. This is a massive audience that every alarm company's website ignores.", expectedAiQuery:"alarm system for renters apartment worth it" },
        ],
        schemaMarkup: `<script type="application/ld+json">\n{\n  "@context": "https://schema.org",\n  "@type": "FAQPage",\n  "mainEntity": [\n    {\n      "@type": "Question",\n      "name": "How much does it cost to monitor my elderly mother who lives alone?",\n      "acceptedAnswer": {\n        "@type": "Answer",\n        "text": "Monitoring for a parent living alone typically runs $35â€“$55/month including 24/7 professional monitoring, a wearable panic button, and motion sensors."\n      }\n    }\n  ]\n}\n</script>`,
      ...
      <div style={{ background:"var(--color-background-secondary)", border:"0.5px solid var(--color-border-tertiary)", borderRadius:10, padding:"14px 16px", marginBottom:12 }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:12 }}>
          ...
          <button onClick={run} disabled={stage==="researching"||stage==="generating"} style={{ padding:"8px 14px", background:(stage==="researching"||stage==="generating")?"transparent":MODULE_COLOR, border:`0.5px solid ${MODULE_COLOR}`, borderRadius:6, color:(stage==="researching"||stage==="generating")?MODULE_COLOR:"#0B0E16", fontSize:12, fontWeight:500, cursor:(stage==="researching"||stage==="generating")?"not-allowed":"pointer", whiteSpace:"nowrap", flexShrink:0 }}>
            {stage==="researching"||stage==="generating"?"Working...":stage==="done"?"Regenerate â†’":"Research + Generate â†’"}
          </button>
        </div>
      </div>
        ...
        <div style={{ border:"0.5px solid var(--color-border-tertiary)", borderRadius:10, padding:"14px 16px", marginBottom:12 }}>
          ...
          {STAGES.map((s, i) => (
            <div key={i} style={{ display:"flex", gap:10, alignItems:"center", marginBottom:6 }}>
              <div style={{ width:16, height:16, borderRadius:"50%", background:i<=progress?MODULE_COLOR:"var(--color-background-secondary)", border:`0.5px solid ${i<=progress?MODULE_COLOR:"var(--color-border-tertiary)"}`, flexShrink:0, display:"flex", alignItems:"center", justifyContent:"center", fontSize:8, color:"#0B0E16" }}>{i<=progress?"âœ“":""}</div>
        ...
        <div>
          ...
          {result.topUnansweredQuestions?.length > 0 && (
            <div style={{ background:"#F8717108", border:"0.5px solid #F8717130", borderRadius:8, padding:"10px 13px", marginBottom:10 }}>
              <div style={{ fontSize:9, color:"#F87171", fontWeight:500, marginBottom:6, letterSpacing:"0.6px" }}>ZERO LOCAL COMPETITION ON THESE â€” FIRST TO PUBLISH OWNS THEM</div>
            ...
            <div style={{ background:"#10D9A008", border:"0.5px solid #10D9A030", borderRadius:8, padding:"9px 12px", marginBottom:10 }}>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:3 }}>
                {result.expectedRankingQueries.map((q, i) => (
                  <div key={i} style={{ fontSize:11, color:"var(--color-text-primary)", fontStyle:"italic" }}>â†’ "{q}"</div>
                ))}
              </div>
            </div>
          )}
                    ...
                    <div key={q.id||i} style={{ borderBottom:i<filtered.length-1?"0.5px solid var(--color-border-tertiary)":"none" }}>
                      <div onClick={() => setExpanded(isExp?null:i)} style={{ display:"flex", gap:10, alignItems:"flex-start", padding:"10px 12px", cursor:"pointer", background:isExp?"var(--color-background-secondary)":"transparent" }}>
                        ...
                        <div style={{ flex:1 }}>
                          ...
                          {!isExp && <div style={{ fontSize:10, color:"var(--color-text-secondary)", marginTop:2 }}>Tap to see before/after â†’</div>}
                        </div>
                        <span style={{ fontSize:10, color:"var(--color-text-secondary)", flexShrink:0 }}>{isExp?"â–²":"â–¼"}</span>
                      </div>
